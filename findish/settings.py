...
SECRET_KEY = 'ya7u=qurd@c-%3=g!*^da)vvf!pge^4gpw3$)6c+(4%-!(2tw+'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['mydjangosecondapp.herokuapp.com', '127.0.0.1']
...
WSGI_APPLICATION = 'findish.wsgi.application'
